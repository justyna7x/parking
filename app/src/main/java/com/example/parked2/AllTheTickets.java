...
public class AllTheTickets extends Fragment {
    ...
    public AllTheTickets() {
        // Required empty public constructor
    }

    public static AllTheTickets newInstance(String param1, String param2) {
        AllTheTickets fragment = new AllTheTickets();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TicketsView =  inflater.inflate(R.layout.alltickets_fragment, container, false);
    ...
    public void onStart(){
        ...
        FirebaseRecyclerAdapter<Ticket, TicketsFragment.TicketsViewHolder> adapter = new FirebaseRecyclerAdapter<Ticket, TicketsFragment.TicketsViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull TicketsFragment.TicketsViewHolder holder, int position, @NonNull Ticket ticket) {
            ...
            @NonNull
            @Override
            public TicketsFragment.TicketsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_view_ticket, viewGroup, false);
                TicketsFragment.TicketsViewHolder viewHolder = new TicketsFragment.TicketsViewHolder(view);
                return viewHolder;
            }
        };
